...
Ссылка временная: `replicate.delivery` через некоторое время отдаёт 404. Для публикации на сайте картинку надо скачать в `src/assets/covers/` — это делает агент `cover-artist`, а не этот скилл.
